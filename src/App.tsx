...
const App = () => {
    ...
    const loadingMessages = [
        "Preparando as melhores oportunidades para você...",
        "Buscando os melhores parceiros...",
        "Organizando as ofertas da Vila Formosa e região para você...",
        "Conectando você aos melhores benefícios da Vila Formosa e região...",
        "Carregando as novidades de hoje..."
    ];
    ...
    if (loading) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50 flex-col px-4 text-center">
                ...
                <p className="mt-4 text-xs font-bold text-slate-400 uppercase tracking-widest leading-relaxed">
                    {randomMessage}
                </p>
            </div>
        );
